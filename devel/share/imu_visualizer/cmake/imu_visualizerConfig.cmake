...
if("TRUE" STREQUAL "TRUE")
  set(imu_visualizer_SOURCE_PREFIX /home/dittz-ubuntu/kel1/src/imu_visualizer)
  set(imu_visualizer_DEVEL_PREFIX /home/dittz-ubuntu/kel1/devel)
  ...
  set(imu_visualizer_INSTALL_PREFIX /home/dittz-ubuntu/kel1/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'dittz-ubuntu <dittz-ubuntu@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_visualizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dittz-ubuntu/kel1/src/imu_visualizer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT imu_visualizer_NUM_DUMMY_TARGETS)
      set(imu_visualizer_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::imu_visualizer::wrapped-linker-option${imu_visualizer_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR imu_visualizer_NUM_DUMMY_TARGETS "${imu_visualizer_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::imu_visualizer::wrapped-linker-option${imu_visualizer_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND imu_visualizer_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dittz-ubuntu/kel1/devel/lib;/home/dittz-ubuntu/kel1/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(imu_visualizer_EXPORTED_TARGETS ${${imu_visualizer_dep}_EXPORTED_TARGETS})
endforeach()
